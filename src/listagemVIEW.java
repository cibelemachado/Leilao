...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
      try {
        ...
        if (idTexto.isEmpty()) {
             JOptionPane.showMessageDialog(null,"Digite o ID do produto a ser vendido.");
             return;
        }
        ...
        ProdutosDTO produto = dao.buscarProdutoPorId(id);
        ...
        if ("Vendido".equalsIgnoreCase(produto.getStatus())) {
            JOptionPane.showMessageDialog(null, 
                    "Este produto já foi vendido! Escolha outro.");
            return;            
        }
        ...
        id_produto_venda.setText("");
            ...
            JOptionPane.showMessageDialog(null, "Digite um ID válido (número inteiro).");
